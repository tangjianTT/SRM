 ...
 */
@Repository
public class DictSubDO implements Serializable {
	...
	public void setDictSubCode(String dictSubCode) {
		this.dictSubCode = dictSubCode == null ? null : dictSubCode.trim();
	}
	...
	public String toString() {
		return "DictSubDO [dictSubCode=" + dictSubCode + ", id=" + id + ", dictMainCode=" + dictMainCode + ", lableKey="
				+ lableKey + ", lableName=" + lableName + ", sortNo=" + sortNo + ", gmtCreate=" + gmtCreate
				+ ", createBy=" + createBy + ", gmtModified=" + gmtModified + ", lastModifiedBy=" + lastModifiedBy
				+ ", remark=" + remark + ", delFlag=" + delFlag + ", txt1=" + txt1 + ", txt2=" + txt2 + "]";
	}
}